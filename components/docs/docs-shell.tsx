...
export function DocsShell({
  ...
  return (
    <div className="relative isolate min-h-screen overflow-hidden bg-[#070b10]">
      ...
      <header className="sticky top-0 z-40 border-b border-white/10 bg-[#0a0f15]/88 backdrop-blur-xl">
      ...
      <footer className="relative z-10 border-t border-white/8">
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-3 px-4 py-8 text-xs text-white/40 md:flex-row md:items-center md:justify-between md:px-6">
          <p>© {new Date().getFullYear()} Aurove. Protocol documentation for Mezo testnet deployments.</p>
